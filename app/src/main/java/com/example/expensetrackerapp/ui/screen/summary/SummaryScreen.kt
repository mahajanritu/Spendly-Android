...
fun SummaryScreen(
    ...
    val expenseList = when (tabIndex.intValue) {
    ...
    Column(
        ...
        // FIXED: Header text color set to Purple
        Text(
            text = "Your Summary",
        ...
        if (expenseList.value.isEmpty()) {
            Column(
                ...
                // FIXED: Empty state text color set to Purple
                Text(
                    text = "No Expense Yet",
                    color = Color(0xFF7766F7),
                    fontSize = 16.sp,
...
fun Tabs(tabIndex: MutableIntState) {
    Row(
        ...
        TabSummaryList.forEachIndexed { index, items ->
            val isSelected = tabIndex.intValue == index
            OutlinedButton(
...
fun SummaryList(expenseList: State<List<Expense>>) {
    ...
    Column(
        ...
        LazyColumn {
            items(uniqueCategories) { categories ->
...
fun CardSummaryItem(categories: String, expenseList: State<List<Expense>>, totalAmount: Int) {
    ...
    val progressFloat = (percentage / 100).toFloat()
        ...
        Row(
            ...
            Row(
                ...
                Icon(
                    ...
                    tint = Color(0xFF7766F7) // Icon tint updated to match theme
                )
                Spacer(modifier = Modifier.width(16.dp))
                Column(
                    modifier = Modifier.width(160.dp)
                ) {
                    // FIXED: Category name text color set to Purple
                    Text(
                        text = categories,
                        color = Color(0xFF7766F7),
                        fontSize = 16.sp,
                    ...
                    LinearProgressIndicator(
                        ...
                        color = Color(0xFF7766F7),
                        trackColor = colorResource(id = R.color.secondary)
                    )
                }
            }
            Column(
                ...
                // FIXED: Amount and percentage text colors set to Purple
                Text(
